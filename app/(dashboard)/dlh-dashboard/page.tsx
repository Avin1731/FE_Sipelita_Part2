...
export default function DashboardPage() {
    ...
    const timelineData: TimelineItem[] = [
        ...
        { title: 'Penentuan Bobot Antar Penghargaan', subtitle: 'Menunggu', status: 'menunggu' },
        { title: 'Validasi 1', subtitle: 'Menunggu', status: 'menunggu' },
        { title: 'Validasi 2', subtitle: 'Menunggu', status: 'menunggu' },
        { title: 'Wawancara & Perhitungan NT Final', subtitle: 'Menunggu', status: 'menunggu' },
    ];
    ...
    const jadwalData: ScheduleItem[] = [
        ...
        { tahap: 'Penilaian Penghargaan', keterangan: 'Upload & verifikasi nilai penghargaan oleh PUSDATIN', mulai: '11 Jan 2026', deadline: '25 Jan 2026', status: 'Belum Dimulai' },
    ...
    const notifData: NotificationItem[] = [
    {
        type: 'pengumuman',
        title: 'Pengumuman',
        subtitle: 'Jadwal penilaian SLHD telah rilisn.\nMohon periksa detailnya.'
    },
    {
        type: 'notifikasi',
        title: 'Notifikasi',
        subtitle: 'Tim penilai sedang mereview dokumen Anda.\nHasil akan diumumkan segera.'
    },
    ];
